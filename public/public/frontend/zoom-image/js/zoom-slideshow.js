			...
			var diaporama = {
				...
				_previous: function(pos) {
					if (this._currentImg > 0) {
						...
						var previousCursolButton = "previousCursolButton";

						this._animateThumbs(pos,previousCursolButton);
				...
				_next: function(pos) {
					if (this._currentImg < this._totalImg) {
						...
						var nextCursolButton = "nextCursolButton";

						this._animateThumbs(pos,nextCursolButton);

						this._showPicture($(this._opt.thumbsContainer).find("img")[this._currentImg]);
					}
				},

				_animateThumbs: function(pos,cursolButton=null) {
					var me = this;

					if (cursolButton == 'nextCursolButton') {
