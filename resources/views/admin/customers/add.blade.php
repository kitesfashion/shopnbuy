			...
			<div class="card" style="margin-bottom: 200px;">
				...
				<div class="card-body">
					...
					<div class="modal-body">
						<form class="form-horizontal" action="{{ route('customer.customerSave') }}" method="post" enctype="multipart/form-data">
							{{ csrf_field() }}
							...
							<div class="row">
								<div class="col-md-6">
	                                <div class="form-group {{ $errors->has('dob') ? ' has-danger' : '' }}">
	                                    ...
	                                    <input  type="text" class="form-control add_datepicker" id="dob" name="dob">
	                                    @if ($errors->has('dob'))
