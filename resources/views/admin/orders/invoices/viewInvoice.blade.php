...
<style type="text/css">
    ...
    <div class="panel">
            ...
            <div class="invoice-address">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <div class="inv-col"><span>Payment Method: </span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center ">
            <a href="{{ route('manualInvoice.pdf',$order->id) }}" target="_blank" class="btn btn-primary btn-lg" ><i class="fa fa-print"></i> View PDF </a>
        </div>
    </div>
@endsection
