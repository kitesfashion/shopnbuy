    ...
    <table class="orderList" width="100%" style="margin-top: 20px;">
        ...
        <tr style="text-align: center;line-height: 12px;">
            ...
            <td>
             ...
             <td>
                <p class="price"><?php echo $orderdetails->productCode; ?></p>
                
            </td>
            <td class="text-center"><?php echo $orderdetails->productPrice; ?></td>
            <td class="text-center"><?php echo $orderdetails->productQuantity; ?>
            </td>
            <td class="text-center"> <?php echo $orderdetails->productAmount; ?></td>
        </tr>
